                        ...
                        <form className="flex justify-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="relative pointer-events-auto">
                                <Input
                                    ...
                                    size="lg"
                                    error={error}
                                    className="focus:ring-0 min-w-[300px] pr-20"
                                    value={search}
                                />
                                <ANEPBtn
                                    type="submit"
                                    icon="material-symbols:search-rounded"
                                    className="!absolute right-0.5 top-0.5 scale-95"
                                />
                            </div>
                        </form>
                    </div>
            ...
            <div className="mt-6 grid grid-cols-3 justify-items-center items-start gap-3">
                <div className="p-4 flex flex-col justify-between items-stretch gap-y-6 bg-anep-secondary rounded-lg drop-shadow-md">
                    <div className="flex justify-between items-center gap-x-3">
                        ...
                        <div>
                            <h2 className="text-xl text-black font-bold">
                                El Mahdi Saissi Hassani
                            </h2>
                            <h3 className="text-anep-dark font-semibold">
                                INGENIEUR EN CHEF GRADE PRINCIPAL (N.S)
                            </h3>
                            <p className="text-sm font-medium">
                                <span className="font-bold">État:</span> mis à
                                disponibilité
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col justify-between items-start gap-y-2 child:px-2.5 child:py-1 child:bg-blue-100 child:border child:border-blue-300 child:rounded-full">
                        <h4>Directeur Géneral / Directeur Géneral Adjoint</h4>
                        <h4>Directeur des Affaires Techniques</h4>
                    </div>
